...
if (isset($_GET['signup'])) {
  ...
  if ($_GET['signup'] == 'success') {
    ...
    echo '<div class="alert"><span class="closebtn">&times;</span><p>You have successfully registed and sign in <a href="sign-in.php">here</a>.</p></div>';
  ...
  if ($_GET['error'] == 'usertaken') {
    ...
    echo '<div class="alert error"><span class="closebtn">&times;</span><p>\''.$takenemail.'\' is already taken. Please enter another email address.</p></div>';
  ...
  if ($_GET['error'] == 'empty') {
    ...
    echo '<div class="alert error"><span class="closebtn">&times;</span><p>Invalid name! The name does not allowed symbols.</p></div>';
    ...
    echo '<div class="alert error"><span class="closebtn">&times;</span><p>Invalid E-mail address! Please enter valid E-mail address.</p></div>';
    ...
    echo '<div class="alert error"><span class="closebtn">&times;</span><p>Password is not match! Please enter same password both places.</p></div>';
...
<head>
  ...
  <title>Sign Up - Infinity Traveler</title>
</head>
<style>
  ...
  <div class="newClass">
    ...
    <form action="inc/signup.php" method="post">
      ...
      <fieldset>
        ...
        <legend>SignUp - Traveller</legend>
